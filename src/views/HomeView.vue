...
<template>
  ...
  <div class="x text-center">
    ...
    <br />
    <br />
    <h1 class="p">Bismillahirrahmanirrahim</h1>
    <br />
    <img src="../assets/LogoQuran.png" alt="logo" width="400px" />
    <br />
    <br />
  ...
  <div id="1">
    <div class="text-center">
      <h1 class="p">Silahkan ketikkan nomor surat!</h1>
    </div>
    <div class="search">
      <input
        v-model="cari"
...
.pa {
  font-family: Roboto;
  background: linear-gradient(50deg, #82954b, #446a46);
